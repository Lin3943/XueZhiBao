package com.zyl.xuezhibao.widget.LoadMore;
...
public class LoadMoreWrapper extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public static final int ITEM_TYPE_NO_VIEW = Integer.MAX_VALUE - 4;//不展示footer view_
    ...
    private ViewHolder getNoMoreViewHolder() {
        if (mNoMoreView == null) {
            ...
            ((TextView) mNoMoreView).setText("全部加载完");
