package com.zyl.xuezhibao.view.find.psychagogy;
...
public class PsychagogyActivity extends FragmentActivity {

    private ImageButton mBack;
    private List<String> mList;
    private RecyclerView mRecyclerView;
    private TextView mTvTitle;
    private PsychagogyAdapter mAdapter;
    private SmartRefreshLayout mRefresh;
    private String mMsg;
    private LinearLayout mNotPsychagogyNow;
    ...
    private void initUI() {
        ...
        mNotPsychagogyNow = (LinearLayout) findViewById(R.id.llt_not_psychagogy_now);
    }
    ...
    private void initRecylerView(List<String> date) {
        mAdapter = new PsychagogyAdapter(date, this);
    ...
    protected void onResume() {
        ...
        if (mList != null && mList.size() != 0) {
            ...
            mNotPsychagogyNow.setVisibility(View.VISIBLE);
        }
    ...
    class MyHandler extends Handler {
        // 弱引用 ，防止内存泄露
        private WeakReference<PsychagogyActivity> weakReference;

        public MyHandler(PsychagogyActivity activity) {
            weakReference = new WeakReference<PsychagogyActivity>(activity);
        }
        ...
        public void handleMessage(Message msg) {
            ...
            PsychagogyActivity activity = weakReference.get();
            // 防止内存泄露
            if (activity != null) {
