package com.zyl.xuezhibao.view.find.publicbenefit;
...
public class PublicBenifitActivity extends FragmentActivity implements View.OnClickListener,ViewPager.OnPageChangeListener {
...
//                break;
    ...
    private void initRecycleView() {
        if (mPublicBenifitNowList != null && mPublicBenifitNowList.size() != 0) {
            PublicBenifitOneAdapter adapter = new PublicBenifitOneAdapter(mPublicBenifitNowList, this);
        ...
        if (mPublicBenifitPreList != null && mPublicBenifitPreList.size() != 0) {
            PublicBenifitTwoAdapter adapter = new PublicBenifitTwoAdapter(mPublicBenifitPreList, this);
            LinearLayoutManager gridLayoutManager = new LinearLayoutManager(this);
