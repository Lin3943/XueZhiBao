package com.zyl.xuezhibao.view.find.teacher;
...
public class TeachersActivity extends FragmentActivity {
    ...
    private String mMsg;
    private LinearLayout mNotWebCastNow;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_find_webcast);
        initUI();
        initData();
    }
    ...
    private void initUI() {
        ...
        mRecyclerView = (RecyclerView) findViewById(R.id.rcv_find_webcast);
        mTvTitle = (TextView) findViewById(R.id.tv_find_title);
        mRefresh = (SmartRefreshLayout) findViewById(R.id.srlt_find_webcast_refresh);
        mNotWebCastNow = (LinearLayout) findViewById(R.id.llt_not_webcast_now);
    }
    ...
    private void initRecylerView(List<String> date) {
        mAdapter = new TeachersAdapter(date, this);
    ...
    protected void onResume() {
        ...
        if (mList != null && mList.size() != 0) {
            ...
            mNotWebCastNow.setVisibility(View.VISIBLE);
        }
    ...
    class MyHandler extends Handler {
        // 弱引用 ，防止内存泄露
        private WeakReference<TeachersActivity> weakReference;

        public MyHandler(TeachersActivity activity) {
            weakReference = new WeakReference<TeachersActivity>(activity);
        }
        ...
        public void handleMessage(Message msg) {
            ...
            TeachersActivity activity = weakReference.get();
            // 防止内存泄露
            if (activity != null) {
