package com.zyl.xuezhibao.view.find.teachingresearch;
...
public class TeachingResearchActivity extends FragmentActivity implements View.OnClickListener,ViewPager.OnPageChangeListener {
    ...
    private LinearLayout mNotPublicBenifitNow;
    private LinearLayout mNotPublicBenifitPre;
    private List<String> mPublicBenifitNowList;
    private List<String> mPublicBenifitPreList;
...
//    private int two = 0; //滑动条移动两页的距离
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_find_publicbenifit);
        initUI();
        initData();
        initListener();
    }
    ...
    private void initUI() {
        ...
        mTvTitle = (TextView) findViewById(R.id.tv_publicbenifit_title);
        tv_one = (TextView) findViewById(R.id.tv_one);
        tv_two = (TextView) findViewById(R.id.tv_two);
        mViewPager = (ViewPager) findViewById(R.id.vp_find_publicbenifit);
...
//                break;
    ...
    private void initData() {
        mPublicBenifitPreList = new ArrayList<>();
        mPublicBenifitNowList = new ArrayList<>();
        Bundle bundle = getIntent().getExtras();
        if (bundle != null) {
            mMsg = bundle.getString(FIND);
            mTvTitle.setText(mMsg);
        }
        mPublicBenifitPreList.add(mMsg);
    }
    ...
    private void initRecycleView() {
        if (mPublicBenifitNowList != null && mPublicBenifitNowList.size() != 0) {
            TeachingResearchOneAdapter adapter = new TeachingResearchOneAdapter(mPublicBenifitNowList, this);
            LinearLayoutManager gridLayoutManager = new LinearLayoutManager(this);
            mRcvVPone.setLayoutManager(gridLayoutManager);
            mRcvVPone.setAdapter(adapter);
        } else {
            mNotPublicBenifitNow.setVisibility(View.VISIBLE);
        }
        if (mPublicBenifitPreList != null && mPublicBenifitPreList.size() != 0) {
            TeachingResearchTwoAdapter adapter = new TeachingResearchTwoAdapter(mPublicBenifitPreList, this);
            LinearLayoutManager gridLayoutManager = new LinearLayoutManager(this);
            mRcvVPtwo.setLayoutManager(gridLayoutManager);
            mRcvVPtwo.setAdapter(adapter);
        } else {
            mNotPublicBenifitPre.setVisibility(View.VISIBLE);
        }
    }
    ...
    private void setVP() {
        ...
        mNotPublicBenifitNow = (LinearLayout) mViewOne.findViewById(R.id.llt_not_crowdraise_now);
        mNotPublicBenifitPre = (LinearLayout) mViewTwo.findViewById(R.id.llt_not_crowdraise_pre);
    }
