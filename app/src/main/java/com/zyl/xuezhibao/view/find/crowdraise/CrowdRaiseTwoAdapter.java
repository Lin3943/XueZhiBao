...
public class CrowdRaiseTwoAdapter extends CommonAdapter<String> {

    private List<String> list;//存放数据
    private Context mContext;

    public CrowdRaiseTwoAdapter(List<String> list, Context context) {
        super(context,R.layout.item_layout_find_crowdraise_two,list);
        this.list = list;
