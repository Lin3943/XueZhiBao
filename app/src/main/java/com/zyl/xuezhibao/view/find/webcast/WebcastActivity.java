package com.zyl.xuezhibao.view.find.webcast;
...
//        mList.add(mMsg);
    ...
    private void initRecylerView(List<String> date) {
        mAdapter = new WebcastAdapter(date, this);
    ...
    class MyHandler extends Handler {
        // 弱引用 ，防止内存泄露
        private WeakReference<WebcastActivity> weakReference;

        public MyHandler(WebcastActivity activity) {
            weakReference = new WeakReference<WebcastActivity>(activity);
        }
        ...
        public void handleMessage(Message msg) {
            ...
            WebcastActivity activity = weakReference.get();
            // 防止内存泄露
            if (activity != null) {
