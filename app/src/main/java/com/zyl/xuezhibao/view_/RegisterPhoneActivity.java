...
public class RegisterPhoneActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void initView() {
        mActivityRegisterLogin = (TextView) findViewById(R.id.go_back_register_login);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.go_back_register_login://去登录
                finish();
                break;
    ...
    private void getSendSms(String phone) {
        ...
        OkHttpUtils.post().url(Constants.Url.SendSms_URL).params(requestMap).build().execute(new StringCallback() {
            ...
            public void onError(Call call, Exception e, int id) {
                ToastUtils.showShort(RegisterPhoneActivity.this,"网络异常！");
            }
            @Override
            public void onResponse(String response, int id) {
                ...
                try {
                    ...
                    if ("success".equals(object.getString("status"))){
                        mTimeCount.start();
                        ToastUtils.showShort(RegisterPhoneActivity.this,object.getString("message"));
                    }else {
                        ToastUtils.showShort(RegisterPhoneActivity.this,object.getString("message"));
                    }
                } catch (Exception e) {
            ...
            public void onResponse(String response, int id) {
                try {
                    ...
                    if (status.equals("success")){
                        ...
                        Intent intent = new Intent(RegisterPhoneActivity.this,MainFragmentActivity.class);
//                        UMengAliasUtils.setUMengAlias(RegisterPhoneActivity.this,mSharePerence.getMemberInfo().getPhone());
