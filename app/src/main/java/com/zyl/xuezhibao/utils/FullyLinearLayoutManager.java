...
public class FullyLinearLayoutManager extends LinearLayoutManager {
    ...
    public void setOverScrollMode(int overScrollMode) {
        ...
        if (this.view == null) throw new IllegalStateException("view_ == null");
    ...
    public void onMeasure(RecyclerView.Recycler recycler, RecyclerView.State state, int widthSpec, int heightSpec) {
        ...
        // done). As we want to measure the view_ with actual data we must use data from the adapter and not from  the
        // state
    ...
    private void measureChild(RecyclerView.Recycler recycler, int position, int widthSize, int heightSize, int[] dimensions) {
        ...
        // as view_ is recycled let's not keep old measured values
        makeInsetsDirty(p);
