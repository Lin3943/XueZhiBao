...
public class MaterialHeaderView extends QLoadView {
    ...
    private q.rorbin.qrefreshlayout.widget.material.CircleImageView mImageView;
    private q.rorbin.qrefreshlayout.widget.material.MaterialProgressDrawable mProgressDrawable;
    ...
    private void init(Context context) {
        ...
        mImageView = new q.rorbin.qrefreshlayout.widget.material.CircleImageView(context, CIRCLE_BG_LIGHT, mCircleSize);
        mProgressDrawable = new q.rorbin.qrefreshlayout.widget.material.MaterialProgressDrawable(context, this);
        ...
        mProgressDrawable.updateSizes(q.rorbin.qrefreshlayout.widget.material.MaterialProgressDrawable.LARGE);
